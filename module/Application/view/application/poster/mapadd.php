...
<input type="button" value="ѡ���ע" onclick="openStylePnl()" />
<input type="button" value="�ر�" onclick="mkrTool.close()" />
<div id="divStyle" >
    <ul>
        <li>
...
html.push('          <input type="button" name="btnOK"  onclick="fnOK()" value="����豸��">&nbsp;&nbsp;');
html.push('		     <input type="button" name="btnClear" onclick="fnClear();" value="����">');
html.push('	     </td>');
html.push('  </tr>');
html.push('</table>');	

var infoWin = new BMap.InfoWindow(html.join(""), {offset: new BMap.Size(0, -10)});
var curMkr = null; // ��¼��ǰ��ӵ�Mkr
...
function selectStyle(index){
    mkrTool.open(); //�򿪹��� 
    var icon = BMapLib.MarkerTool.SYS_ICONS[index]; //���ù�����ʽ��ʹ��ϵͳ�ṩ����ʽBMapLib.MarkerTool.SYS_ICONS[0] -- BMapLib.MarkerTool.SYS_ICONS[23]
